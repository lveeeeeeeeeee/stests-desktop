...
namespace Stests.DisplayTestsControl
{
    ...
    {
        private static TestInfoControl.TestInfoPlug[] objectsToDisplay { get; set; } = new TestInfoControl.TestInfoPlug[5];
        ...
        private void GetObjectsToDisplay()
        {
            ...
            {
                objectsToDisplay[i] = new TestInfoControl.TestInfoPlug($"пример как должно работать {i+1}");
                i++;
            }
        }
